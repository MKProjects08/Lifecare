        ...
        <table className="min-w-full table-auto">
          ...
          <tbody>
            {agencies.length === 0 ? (
              ...
              agencies.map((agency) => (
                <tr key={agency.Agency_ID || agency.id} className="border-b border-[#E1F2F5] hover:bg-gray-50 text-left">
                  ...
                  <td className="py-3 px-4">
                    <div className="flex">
                      <button
                        ...
                        className="flex items-center  text-white  py-1 rounded text-sm"
                        title="View Agency"
                      >
                      ...
                      <button
                        ...
                        className="flex items-center  text-white  py-1 roundedtext-sm"
                        title="Edit Agency"
                      >
