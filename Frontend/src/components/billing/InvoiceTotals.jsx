...
const InvoiceTotals = ({ grossTotal, discount, freeQuantityDiscount, netTotal, onDiscountChange }) => {
  const totalDiscount = discount + freeQuantityDiscount;

  return (
    <div className="border-t border-gray-200 pt-6">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 max-w-lg ml-auto">
        ...
        <div className="text-right">
          ...
          <p className="text-sm font-medium text-gray-700 mt-2">Net Total:</p>
